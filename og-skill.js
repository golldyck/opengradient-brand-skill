...
(function (global) {
  ...
  /* ============================================================
     LOGO SVG — MARK ONLY
     Stroke-based interlocking diamond mark — matches official
     OpenGradient brand kit (notion.so PNG-Files brand kit).
     Uses stroke="currentColor" so color is CSS-controllable.
  ============================================================ */
  var LOGO_MARK =
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none">' +
    /* Outer rounded-diamond frame (rotated square with large corner radius) */
    '<rect x="19" y="19" width="62" height="62" rx="14" ry="14" transform="rotate(45 50 50)" stroke="currentColor" stroke-width="7.5" fill="none"/>' +
    /* Vertical petal: tall rounded rect through center */
    '<rect x="33.5" y="11" width="33" height="78" rx="16.5" stroke="currentColor" stroke-width="7.5" fill="none"/>' +
    /* Horizontal petal: wide rounded rect through center */
    '<rect x="11" y="33.5" width="78" height="33" rx="16.5" stroke="currentColor" stroke-width="7.5" fill="none"/>' +
    /* Center circle */
    '<circle cx="50" cy="50" r="7.5" stroke="currentColor" stroke-width="7.5" fill="none"/>' +
    '</svg>';
